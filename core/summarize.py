...
def split_transcribe(transcribe : str) -> list:
...
def summarize(transcript : str) -> str:
    ...
    combined_prompt = ChatPromptTemplate.from_messages([
        ('system' , 'You are an expert meeting summarizer. Combine these partial summaries into one final professional meeting summary in the bullet points.'),
        ('human' , '{text}')
    ])
